...
public class CurrentSolutionPoint extends Observable {
    ...
    public void advance(final Double currentTime, final Map<ModelInstance, Map<ScalarVariable, Object>> currentValues,
            final Map<ModelInstance, Map<ScalarVariable, Map<Integer, Double>>> currentDerivatives, final Double prevStepsize,
    ...
    public void peek(final Double nextTime, final Map<ModelInstance, Map<ScalarVariable, Object>> nextValues) {
    ...
    public Boolean wasLastStepsizeLimitedByDiscreteConstraint() {
        return wasLastStepsizeLimitedByDiscreteConstraint == null ? false : wasLastStepsizeLimitedByDiscreteConstraint;
    }

    private <T> T retrieveValue(final Map<ScalarVariable, T> values, final Variable variable) {
        if (values == null) {
            return null;
        }
