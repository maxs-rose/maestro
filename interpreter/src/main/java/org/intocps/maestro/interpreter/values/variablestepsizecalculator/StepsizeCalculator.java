...
import org.intocps.orchestration.coe.cosim.varstep.StepValidationResult;
...
import org.intocps.orchestration.coe.cosim.varstep.constraint.ConstraintHandlerFactory;
import org.intocps.orchestration.coe.cosim.varstep.constraint.FmuMaxStepSizeHandler;
...
public class StepsizeCalculator {
    ...
    private final org.intocps.orchestration.coe.cosim.varstep.StepsizeInterval stepsizeInterval;
    private FmuMaxStepSizeHandler fmuMaxStepSizeHandler = null;

    public StepsizeCalculator(final Set<Constraint> constraints, final StepsizeInterval stepsizeInterval, final Double initialStepsize,
            final Map<ModelInstance, FmiSimulationInstance> instances) throws AbortSimulationException {
    ...
    private Map<Variable, Types> getTypeMap(final Map<ModelInstance, FmiSimulationInstance> instances) {
    ...
    public org.intocps.orchestration.coe.cosim.varstep.StepValidationResult validateStep(final Double nextTime,
            final Map<ModelInstance, Map<ScalarVariable, Object>> nextValues, final Boolean supportsRollback) {
