 ...
 *		Casper Thule
 */
package org.intocps.maestro.interpreter.values.variablestepsizecalculator.constraint;
...
public class ConstraintHandlerFactory {
    ...
    public static ConstraintHandler getHandler(final Observable obs, final Constraint jc, final StepsizeInterval interval,
    ...
    private static void validatePortTypes(Map<Variable, Types> portTypeMap, Set<Types> validTypes, Constraint jc,
