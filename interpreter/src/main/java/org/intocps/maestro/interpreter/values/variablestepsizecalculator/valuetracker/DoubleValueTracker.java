...
public class DoubleValueTracker implements Observer, ValueTracker {
    ...
    private org.intocps.orchestration.coe.cosim.varstep.valuetracker.DoubleValueTracker previousState = null;
    private final Variable trackedVariable;
    private Double xNext = null;
    private Double x = null;
    private Double xPrev = null;
    private Double xPrevPrev = null;
    private final ScalarDerivativeEstimator derivativeEstimator;
    private final ExtrapolationErrorEstimator extrapolationErrorEstimator;
    private final Integer order;

    public DoubleValueTracker(final org.intocps.orchestration.coe.cosim.varstep.valuetracker.DoubleValueTracker dvt) {
    ...
    public DoubleValueTracker(final Observable observable, final Variable variable, final Integer predictionOrder) {
    ...
    public void update(final Observable obs, final Object arg) {
        if (obs instanceof CurrentSolutionPoint) {
            ...
            if (Operation.ADVANCE.equals(op)) {
                previousState = new org.intocps.orchestration.coe.cosim.varstep.valuetracker.DoubleValueTracker(this);
                xPrevPrev = xPrev;
                xPrev = x;
