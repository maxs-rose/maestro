 ...
 *		Casper Thule
 */
package org.intocps.maestro.interpreter.values.variablestepsizecalculator.constraint.zerocrossing;
...
public class ZerocrossingHandler implements Observer, ConstraintHandler {
    ...
    private org.intocps.orchestration.coe.cosim.varstep.constraint.zerocrossing.ZerocrossingHandler previousState = null;
    ...
    public ZerocrossingHandler(final org.intocps.orchestration.coe.cosim.varstep.constraint.zerocrossing.ZerocrossingHandler zh) {
        tol = zh.tol;
        id = zh.id;
    ...
    public ZerocrossingHandler(final Observable observable, final Constraint constraint, final StepsizeInterval interval,
    ...
    public void update(final Observable obs, final Object arg) {
        if (obs instanceof CurrentSolutionPoint) {
            ...
            if (Operation.ADVANCE.equals(op)) {
                previousState = new org.intocps.orchestration.coe.cosim.varstep.constraint.zerocrossing.ZerocrossingHandler(this);
