 ...
 *		Casper Thule
 */
package org.intocps.maestro.interpreter.values.variablestepsizecalculator.constraint.samplingrate;
...
public class SamplingRateHandler implements Observer, ConstraintHandler {
    ...
    public SamplingRateHandler(final Observable observable, final Constraint jc, final StepsizeInterval interval) {
