 ...
 *		Casper Thule
 */
package org.intocps.maestro.interpreter.values.variablestepsizecalculator.constraint.boundeddifference;
...
public class BoundedDifferenceHandler implements Observer, ConstraintHandler {
    ...
    private org.intocps.orchestration.coe.cosim.varstep.constraint.boundeddifference.BoundedDifferenceHandler previousState = null;
    ...
    public BoundedDifferenceHandler(final Observable observable, final Constraint jc, final StepsizeInterval interval,
    ...
    public BoundedDifferenceHandler(final org.intocps.orchestration.coe.cosim.varstep.constraint.boundeddifference.BoundedDifferenceHandler bdh) {
    ...
    public void update(final Observable obs, final Object arg) {
        if (obs instanceof CurrentSolutionPoint) {
            ...
            if (Operation.ADVANCE.equals(op)) {
                previousState = new org.intocps.orchestration.coe.cosim.varstep.constraint.boundeddifference.BoundedDifferenceHandler(this);
